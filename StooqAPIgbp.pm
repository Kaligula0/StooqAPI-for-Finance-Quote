...
#
package Finance::Quote::StooqAPIgbp;
require 5.004;
...
sub stooq_api_gbp {
  ...
  foreach my $symbol (@symbols) {
    ...
    unless ($date eq "N/A") {
		...
		$stocks{$symbol, 'method'}   = 'stooq_api_gbp';
		$stocks{$symbol, 'source'}   = 'Finance::Quote::StooqAPIgbp';
...
=head1 SYNOPSIS
    ...
    %stockinfo = $q->fetch("stooq_api_gbp","tlt"); # the letter ticker
