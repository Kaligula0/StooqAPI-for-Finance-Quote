...
#
package Finance::Quote::StooqAPIusx;
require 5.004;
...
sub stooq_api_usx {
  ...
  foreach my $symbol (@symbols) {
    ...
    unless ($date eq "N/A") {
		...
		$stocks{$symbol, 'method'}   = 'stooq_api_usx';
		$stocks{$symbol, 'source'}   = 'Finance::Quote::StooqAPIusx';

		$stocks{$symbol, 'currency'} = 'USD';
...
=head1 SYNOPSIS
    ...
    %stockinfo = $q->fetch("stooq_api_usx","tlt"); # the letter ticker
