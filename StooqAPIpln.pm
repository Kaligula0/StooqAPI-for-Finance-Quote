...
#
package Finance::Quote::StooqAPIpln;
require 5.004;
...
sub stooq_api_pln {
  ...
  foreach my $symbol (@symbols) {
    ...
    unless ($date eq "N/A") {
		...
		$stocks{$symbol, 'method'}   = 'stooq_api_pln';
		$stocks{$symbol, 'source'}   = 'Finance::Quote::StooqAPIpln';
...
=head1 SYNOPSIS
    ...
    %stockinfo = $q->fetch("stooq_api_pln","tlt"); # the letter ticker
