...
#
package Finance::Quote::StooqAPIusd;
require 5.004;
...
sub stooq_api_usd {
  ...
  foreach my $symbol (@symbols) {
    ...
    unless ($date eq "N/A") {
		...
		$stocks{$symbol, 'method'}   = 'stooq_api_usd';
		$stocks{$symbol, 'source'}   = 'Finance::Quote::StooqAPIusd';
...
=head1 SYNOPSIS
    ...
    %stockinfo = $q->fetch("stooq_api_usd","tlt"); # the letter ticker
